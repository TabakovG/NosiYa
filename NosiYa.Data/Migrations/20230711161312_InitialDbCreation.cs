    ...
    public partial class InitialDbCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutfitSets", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutfitsForCarts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutfitSets_RegionId",
                table: "OutfitSets",
                column: "RegionId");

            migrationBuilder.CreateIndex(
                name: "IX_OutfitsForCarts_CartId",
                table: "OutfitsForCarts",
                column: "CartId");

            migrationBuilder.CreateIndex(
                name: "IX_OutfitsForCarts_OutfitId",
                table: "OutfitsForCarts",
                column: "OutfitId");
        }
